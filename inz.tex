...
\chapter{Cel prac i wizja produktu}
	Tradycyjne radio powstało na początku XX wieku i do dzisiaj bardzo popularne jest słuchanie audycji radiowych. Według badań\textsuperscript{\cite{iloveradio_stats}} przeprowadzonych w 2022 r., 65\% Polaków słuchało radia codziennie.
	
	\section{Opis problemu}
			Uwarunkowania prawno-ekonomiczne, związane z emisją tradycyjnego programu radiowego i postęp w dziedzinie technologii komunikacyjnych sprawiły, że rozwinęło się radio Internetowe, którego popularność i słuchalność regularnie wzrasta (w roku 2022 było to około 6\% ogółu słuchaczy, a w 2023 powyżej 7,5\%) \textsuperscript{\cite{kim_2022} \cite{kim_2023}}. Z punktu widzenia odbiorcy największe zalety radia internetowego to jego globalny zasięg i różnorodność emitowanych treści przejawiająca się liczbą dostępnych stacji.
			$ $\\
			
			Najpopularniejsza, mająca swoje wady, metoda odbioru radia internetowego wykorzystuje odpowiednie oprogramowanie pracujące na komputerze, natomiast tradycyjny radioodbiornik w ogóle nie umożliwia odbierania nadawanych w ten sposób audycji. Ogranicza to dostępność programów emitowanych przez rozgłośnie internetowe.
			$ $\\
			
			Powstał zatem pomysł zaprojektowania i zbudowania, opisanego w niniejszej pracy, przenośnego urządzenia wbudowanego realizującego funkcję odbiornika Internetowych stacji radiowych.
