...
\definecolor{yellow}{HTML}{d6b656}
...
%		Poniżej zostały przedstawione wymagane funkcjonalności, jak również te dodatkowe.
		...
		\subsection{Wymagane funkcjonalności}
			\begin{itemize}
				\item odtwarzanie stacji internetowych w formacie stereo,
	...
	\section{Przegląd konkurencyjnych rozwiązań}
		Rosnąca popularność internetowych stacji radiowych sprawiła,ze na rynku dostępne są gotowe urządzenia odbiorcze.
...
%		Produkt przedstawiony na rysunku~\ref{1/radio_tanie} to odbiornik z pojedynczym głośnikiem mono. Urządzenie z wbudowaną możliwością odsłuchu bez zewnętrznych elementów to koszt rzędu 230 zł.
		...
		\imgh{1/botland_stm}{Płytka rozwojowa 
			STM32F746G-Disco\textsuperscript{\cite{botland_stm}}}{0.6}
...
%		Jednak pojawiły się obawy o możliwość dekodowania formatu MP3 w czasie rzeczywistym.
...
%	wyjaśnione zostało jak zbudowany został projekt.
