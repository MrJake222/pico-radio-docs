...
%				\item wstrzymywanie odtwarzania,
	...
	\section{Przegląd konkurencyjnych rozwiązań}
		...
		\img{botland_stm}{Droga płytka STM\textsuperscript{\cite{botland_stm}}}
	...
	\section{Interakcja z użytkownikiem}
		...
		\imgss{2/err1}{Błąd odtwarzania}{2/err2}{Błąd ładowania stacji z bazy danych}
