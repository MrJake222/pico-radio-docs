...
\chapter{Wyniki projektu}
	...
	% nazwy akapitów do zmiany
	\section{Stan projektu (software)}
		...
		
		\subsection{title}
			% co działa, co fajne, co niefajne w tej wersji 1.0
		
		\subsection{title}
			% co do wersji 2.0
			% "grubsze" kwestie software?
			%   większy wyświetlacz, TTF, dotykowy ekran??
			%   modem USB (to dobre)
	...
	\section{Warstwa sprzętowa}
		...
		% analogicznie do software
		\subsection{title}
			% co wyszło, co nie wyszło w obecnej wersji sprzętu 1.0
		
		\subsection{title}
			% co można rozważyc do wersji sprzętowej 2.0
