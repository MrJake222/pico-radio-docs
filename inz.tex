...
%				\paragraph{Karta SD -- FatFS}
	...
	\section{Ekran}
		Z uwagi na założenie miniaturyzacji urządzenia wybrany został relatywnie mały ekran. Urządzenie firmy Adafruit o przekątnej 1.8 cala obsługiwane jest poprzez protokół SPI. Moduł wyświetlacza został podzielony na następujące podmoduły:
		\begin{itemize}
		...
		\subsection{Rysowanie}
			Klasa \lstinline|ST7735S| oprócz funkcji do obsługi niskopoziomowej komunikacji wspiera także rysowanie prostokątów, czcionek i ikon.
			...
			\subsubsection{Czcionki}
				...
				\imgh{3/PicoRadio-screen-font}{Kodowanie czcionek (wartości 0x00 zastąpiono pustymi znakami)}{0.8}
				\paragraph{Kodowanie}
