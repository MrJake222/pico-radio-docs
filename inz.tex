...
\chapter{Wyniki projektu}
	...
	\section{Warstwa sprzętowa}
		Projekt od strony sprzętowej został udokumentowany na schemacie przedstawionym w sekcji~\ref{sec:schematics}. Powstała także płytka PCB, oraz obudowa wydrukowana przy użyciu drukarki~3D. Całość widoczna jest na rysunku~\ref{5/hw_result}.
